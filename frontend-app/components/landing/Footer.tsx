      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            <li><Link href="#caracteristicas" className="hover:text-slate-900 transition-colors">Características</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            <li><Link href="#docs" className="hover:text-slate-900 transition-colors">Documentación</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            <li><Link href="#" className="hover:text-slate-900 transition-colors">Acerca de</Link></li>
            <li><Link href="#" className="hover:text-slate-900 transition-colors">Términos</Link></li>
          </ul>
        </div>
      </div>

      <div className="max-w-7xl mx-auto pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between text-sm text-slate-500">
        <p>© 2026 FluxSQL — Universidad Privada de Tacna. Todos los derechos reservados.</p>
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          <Link href="https://github.com" className="hover:text-slate-900 transition-colors">
